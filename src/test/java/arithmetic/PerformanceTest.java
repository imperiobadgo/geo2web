...
public class PerformanceTest {
    ...
    public void testBenches() throws Exception {
        ...
        fmt.format("| %-22s | %25.2f | %22.2f %% |%n", "geo2web", dbRate, dbRate * 100 / mathRate);
        System.out.print(sb.toString());
        sb.setLength(0);
    ...
    private int benchNumber() {
        ...
        while (time > System.currentTimeMillis()) {
            expression.setVariable("x", new Number(rnd.nextDouble()));
            expression.setVariable("y", new Number(rnd.nextDouble()));
